...
// PIN_Code.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPINCodeApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CPINCodeApp

CPINCodeApp::CPINCodeApp()
{
...
// Единственный объект CPINCodeApp

CPINCodeApp theApp;

// Инициализация CPINCodeApp

BOOL CPINCodeApp::InitInstance()
{
